...
import { deleteImageCloudinary, uploadImageCloudinary } from "../helpers/fetchImage";
...
const AdminEditProduct = ({
    ...
    const fetchEditProduct = async () => {
        const response = await fetch(productApi.editProduct.url, {
            method: productApi.editProduct.method,
            credentials: 'include',
            headers: {
