...
import conocenos_portada                    from '../../assets/conocenos/portada.jpg';
import fondo_amarillo                       from '../../assets/oferta-de-cafe/fondo-amarillo.jpg';
import conocenos_frase                      from '../../assets/conocenos/frase.png';
            ...
            {isLoaded && (
                <div className='flex h-[65vh]'>
                    ...
                    <div className='relative' style={{
                        ...
                        <img src={conocenos_frase} alt="" className='absolute top-4 -left-16 object-scale-down' />
