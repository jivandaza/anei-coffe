...
import contacto_portada                         from '../assets/contacto/portada.jpg';
import fondo_amarillo                           from '../assets/oferta-de-cafe/fondo-amarillo.jpg';
import contacto_frase                           from "../assets/contacto/frase.png";
            ...
            {isLoaded && (
                <div className='flex h-[65vh]'>
                    ...
                    <div className='relative' style={{
                        ...
                        <img src={contacto_frase} alt="" className='absolute top-4 -left-16 object-scale-down' />
