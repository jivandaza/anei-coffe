...
import resp_ambiental_portada               from '../../assets/responsabilidad-ambiental/portada.jpg';
import fondo_amarillo                       from '../../assets/oferta-de-cafe/fondo-amarillo.jpg';
import resp_ambiental_frase                 from '../../assets/responsabilidad-ambiental/frase.png';
            ...
            {isLoaded && (
                <div className='flex h-[65vh]'>
                    <div style={{
                        ...
                        <img src={resp_ambiental_portada}
                    ...
                    <div className='relative' style={{
                        ...
                        <img src={resp_ambiental_frase} alt="" className='absolute top-4 -left-16 object-scale-down' />
