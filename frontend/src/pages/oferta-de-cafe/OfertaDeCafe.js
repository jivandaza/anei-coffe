...
import compra_cafe                                      from '../../assets/oferta-de-cafe/compra-cafe.jpg';
import fondo_amarillo                                   from '../../assets/oferta-de-cafe/fondo-amarillo.jpg';
import oferta_de_cafe                                   from '../../assets/oferta-de-cafe/oferta-de-cafe.png';
            ...
            {isLoaded && (
                <div className='flex h-[65vh]'>
                    ...
                    <div className='relative' style={{
                        ...
                        <img src={oferta_de_cafe} alt="" className='absolute top-4 -left-16 object-scale-down' />
